...
export default function SocialShare({ game, className = '' }: SocialShareProps) {
  // 构建分享URL
  const baseUrl = 'https://gamesdwell.com';  // 实际应用中使用真实域名
  const shareUrl = `${baseUrl}/game/${game.id}`;
  const shareTitle = `Check out ${game.title} on GamesDwell!`;
  const shareDescription = game.description.substring(0, 100) + (game.description.length > 100 ? '...' : '');
  ...
  return (
    <div className={`social-share ${className}`}>
      <h3 className="text-lg font-tech text-secondary mb-3">Share This Game</h3>
